...
const QuickQuoteSummary = ({
  ...
  return (
    <div className="quick-quote-summary well">
      ...
      {quickQuote.CustomerRate &&
        <p className="quick-quote-summary__customer-rate-value">
          {quickQuote.CustomerRate}
        </p>}
      <div className="quick-quote__currency-amount-container">
        ...
        {quickQuoteForm.amount &&
          <p>
            <span className="quick-quote-summary__currency">
              {quickQuoteForm.fromCurrency}
            </span>{" "}
            <span className="quick-quote-summary__amount">
              {onParseAmount(quickQuoteForm.amount)}
            </span>
          </p>}
      </div>
      ...
      <div className="quick-quote__currency-amount-container">
        ...
        {quickQuote.CustomerAmount &&
          <p>
            <span className="quick-quote-summary__currency">
              {quickQuoteForm.toCurrency}
            </span>{" "}
            <span className="quick-quote-summary__amount">
              {onParseAmount(quickQuote.CustomerAmount)}
            </span>
          </p>}
      </div>
      ...
      <Button
        type="button"
        className="btn-primary start-new-quote"
